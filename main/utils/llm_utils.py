...
from main.utils.constants import AZURE_OPENAI_4o_MINI_ENDPOINT, AZURE_OPENAI_4o_MINI_API_KEY, AZURE_OPENAI_4_ENDPOINT, \
    ...
    ANTHROPIC_API_KEY, AZURE_OPENAI_o3_API_KEY, AZURE_OPENAI_o3_MINI_ENDPOINT, AZURE_OPENAI_41_MINI_API_KEY, \
    AZURE_OPENAI_41_MINI_ENDPOINT, AZURE_OPENAI_41_NANO_API_KEY, AZURE_OPENAI_41_NANO_ENDPOINT
...
def get_o41_mini():
    try:
        return AzureChatOpenAI(
            api_key=AZURE_OPENAI_41_MINI_API_KEY,
            azure_endpoint=AZURE_OPENAI_41_MINI_ENDPOINT,
            api_version="2024-12-01-preview",
            timeout=None,
            max_retries=2,
...
def get_o41_nano():
    try:
        return AzureChatOpenAI(
            api_key=AZURE_OPENAI_41_NANO_API_KEY,
            azure_endpoint=AZURE_OPENAI_41_NANO_ENDPOINT,
            api_version="2024-12-01-preview",
            timeout=None,
            max_retries=2,
            azure_deployment="gpt-4.1-mini",
